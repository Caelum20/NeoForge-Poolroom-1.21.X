...
import net.caelum.poolmod.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<Holder<ArmorMaterial>, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<Holder<ArmorMaterial>, List<MobEffectInstance>>())
                    .put(ModArmorMaterials.ABYSSTEEL_ARMOR_MATERIAL,
                            List.of(new MobEffectInstance(MobEffects.WATER_BREATHING, 100, 1, false, false)))
                    .build();
    ...
    public void inventoryTick(ItemStack stack, Level level, Entity entity, int slotId, boolean isSelected) {
        if(entity instanceof Player player && !level.isClientSide() && hasChestplate(player)) {
