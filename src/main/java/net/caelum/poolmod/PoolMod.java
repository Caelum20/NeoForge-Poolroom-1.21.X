...
public class PoolMod {
    ...
    public PoolMod(IEventBus modEventBus, ModContainer modContainer) {
    ...
    @EventBusSubscriber(modid = PoolMod.MOD_ID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
